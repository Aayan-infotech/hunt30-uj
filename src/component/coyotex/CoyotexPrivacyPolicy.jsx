...
const cotexPrivecyPolicy = () => {
  ...
  <ul>
    ...
    <li>
      <p>
        <strong>Application</strong> refers to Activity Planner, the software
    ...
    <li>
      <p>
        ...
        "Us" or "Our" in this Agreement) refers to Activity Planner.
      </p>
    </li>
    <li>
      <p>
...
export default cotexPrivecyPolicy
